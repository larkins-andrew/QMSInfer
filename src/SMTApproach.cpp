...
void SMTApproach::monolithicApproach(string benchmarkName) {
...
bool SMTApproach::needToBeChecked(Node node) {
...
bool SMTApproach::threeConditionCheck(Node *node) {
	Node* leftChild;
	Node* rightChild;
...
void SMTApproach::incrementalApproach(string benchmarkName) {
